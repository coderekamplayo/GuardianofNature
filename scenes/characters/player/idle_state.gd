...
func _on_physics_process(_delta : float) -> void:
	# This logic is good for playing the correct idle animation
...
func _on_next_transitions() -> void:
	# --- THIS IS THE FIX ---
	# We transition to Walk if the player IS moving.
...
func _on_enter() -> void:
	# --- BUG FIX ---
	# We should NOT stop the animation when entering the idle state.
	# We want the idle animation to play.
	pass
